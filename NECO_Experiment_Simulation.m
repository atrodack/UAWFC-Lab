...
filename = sprintf('NECO_Closed_loop_%s_%s_and_%s_with_%s',s2,s1,s3,s4);
...
calibration_filename_18 = 'calibrated_dOTF_segment_centers_for_phase_tilt_1_finger_segment_18_no_aliasing.mat';
% calibration_filename_35 = 'calibrated_dOTF_segment_centers_for_phase_finger_segment_35_no_aliasing.mat';
load(calibration_filename_18);
...
PTTpos_mirror = zeros(19,3);
PTT_flat = zeros(19,3);
%% Control Loop
nn = 1;
DM1.isMirror = 0;
correction_start = 6;%6;
numiterations = 9*correction_start;%60;
pixelshift = [1,1];
