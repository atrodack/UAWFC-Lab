...
PSF_poked = PSF_poked(croppoint(1) - 128:croppoint(1) + 128,croppoint(2) - 128:croppoint(2) + 128);
PSF_poked = PSF_poked(1:end-1,1:end-1);
PSF = PSF(croppoint(1) - 128:croppoint(1) + 128,croppoint(2) - 128:croppoint(2) + 128);
